...
description: >-
  ...
  frontend (React, TypeScript), and infrastructure tasks.
tools:
  - read_file
  - write_file
  - replace
...
**IMPORTANT**: Activate relevant skills from `.gemini/skills/*` during execution.
**IMPORTANT**: Follow rules in `./.gemini/rules/development-rules.md` and `./docs/code-standards.md`.
