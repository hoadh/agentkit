...
name: tester
description: >-
  Validate code quality through testing, including running unit and integration tests, 
  analyzing coverage, validating error handling, and checking performance.
tools:
  - run_shell_command
  - read_file
  - glob
