...
Send Gemini CLI notifications to Slack using Block Kit formatted messages.
...
3. Name it (e.g., "Gemini CLI Notifications")
...
| AskUserPrompt | Gemini needs user input |
...
**Script Location:** `.gemini/hooks/notifications/notify.cjs`

**Configuration File:** `~/.gemini/.env` or `.gemini/.env`
