...
function buildSubagentStopEmbed(input) {
  ...
  return {
    title: 'Gemini CLI Subagent Complete',
...
function buildAskUserPromptEmbed(input) {
  ...
  return {
    title: 'Gemini CLI Needs Input',
    description: 'Gemini is waiting for user input',
...
function buildDefaultEmbed(input) {
  ...
  return {
    title: 'Gemini CLI Event',
    description: 'Gemini CLI event triggered',
