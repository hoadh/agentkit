...
test('formatConfigPath with geminiDir', formatConfigPath('/home/user/.gemini').includes('.ckignore'));
test('formatConfigPath without geminiDir', formatConfigPath(null) === '.gemini/.ckignore');
test('formatConfigPath empty string', formatConfigPath('') === '.gemini/.ckignore');
