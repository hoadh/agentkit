 ...
 *
 * Run: node --test .gemini/hooks/tests/scout-block/scout-checker.test.cjs
 */
...
describe('isVenvExecutable', () => {
  ...
  it('matches nested .venv path', () => {
    assert.ok(isVenvExecutable('~/.gemini/skills/.venv/bin/python3 script.py'));
  });
