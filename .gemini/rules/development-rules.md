...
## Visual Aids
- Use `skill:preview --explain` when explaining unfamiliar code patterns or complex logic
- Use `skill:preview --diagram` for architecture diagrams and data flow visualization
- Use `skill:preview --slides` for step-by-step walkthroughs and presentations
- Use `skill:preview --ascii` for terminal-friendly diagrams (no browser needed to understand)
