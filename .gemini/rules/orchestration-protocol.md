...
For multi-session parallel collaboration, activate the `skill:team` skill.
Not part of the default orchestration workflow. See `.gemini/skills/team/SKILL.md` for templates, decision criteria, and spawn instructions.
