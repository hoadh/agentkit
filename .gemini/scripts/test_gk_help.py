#!/usr/bin/env python3
"""
Comprehensive test suite for gk-help.py
...
def test(name: str, args: str, expect_contains: list[str] = None, expect_type: str = None, expect_not_contains: list[str] = None):
    ...
    if expect_type:
        marker = f"@GK_OUTPUT_TYPE:{expect_type}"
...
def main():
    print("=" * 60)
    print("gk-help.py Comprehensive Test Suite")
    print("=" * 60)
    print()
    ...
    test(
        ...
        "",
        expect_contains=["GeminiKit Commands", "Quick Start"],
    ...
    test(
        ...
        " ",
        expect_contains=["GeminiKit Commands"],
        expect_type="category-guide"
    )
    ...
    categories_with_guides = [
        ...
        ("config", "GeminiKit Configuration"),
    ...
    test(
        ...
        "config",
        expect_contains=["GeminiKit Configuration", ".agent.json"],
        expect_type="comprehensive-docs"
    )

    test(
        "6.2 '.agent.json' → comprehensive docs",
        ".agent.json",
        expect_contains=["GeminiKit Configuration"],
        expect_type="comprehensive-docs"
    )
