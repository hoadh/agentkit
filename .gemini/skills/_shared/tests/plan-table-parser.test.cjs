 ...
 * Run: node .gemini/skills/_shared/tests/plan-table-parser.test.cjs
 */
...
const tmpDir = mkdtempSync(path.join(tmpdir(), 'gk-plan-parser-'));
...
// ============================================================
// M8: Tests merged from unit test file (.gemini/skills/_shared/lib/__tests__/plan-table-parser.test.cjs)
