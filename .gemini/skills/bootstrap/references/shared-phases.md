...
Handled by **gk-cook** skill. Bootstrap-specific notes:
...
- Asset pipeline: `gk-ai-multimodal` (generate/analyze) → `imagemagick` (crop/resize) → background removal if needed
