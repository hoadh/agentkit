...
3. If no logo provided: generate with `gk-ai-multimodal` skill
4. Screenshot wireframes with `gk-chrome-devtools` → save to `./docs/wireframes/`
...
Activate **gk-plan** skill: `skill:plan --auto <requirements>`
...
Activate **gk-cook** skill: `skill:cook --auto <plan-path>`
