...
2. If no logo provided: generate with `gk-ai-multimodal` skill
3. Screenshot wireframes with `gk-chrome-devtools` → save to `./docs/wireframes/`
...
Activate **gk-plan** skill: `skill:plan --fast <requirements>`
