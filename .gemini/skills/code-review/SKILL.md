...
| **Checklist review** | Pre-landing, `skill:ship` pipeline, security audit | `references/checklist-workflow.md` |
...
**Process:**
1. Invoke `skill:scout` with edge-case-focused prompt
...
|------------|-----------|---------|
| `skill:code-review codebase` | `references/codebase-scan-workflow.md` | Scan & analyze the codebase |
| `skill:code-review codebase parallel` | `references/parallel-review-workflow.md` | Ultrathink edge cases, then parallel verify |
