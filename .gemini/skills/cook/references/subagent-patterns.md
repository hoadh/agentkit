...
```
- Use `skill:scout ext` (preferred) or `skill:scout` (fallback)
...
## Parallel Execution
```
Task(subagent_type="fullstagk-developer", prompt="Implement [phase-file] with file ownership: [files]", description="Implement phase [N]")
```
