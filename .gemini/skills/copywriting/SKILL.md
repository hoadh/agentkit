...
```bash
python .gemini/skills/copywriting/scripts/extract-writing-styles.py --list        # List files
python .gemini/skills/copywriting/scripts/extract-writing-styles.py --style <name> # Extract style
```
...
**Primary:** fullstagk-developer | **Related:** brand-guidelines, content-marketing, email-marketing
