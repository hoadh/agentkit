...
**Brand:**
```bash
node .gemini/skills/brand/scripts/inject-brand-context.cjs
node .gemini/skills/brand/scripts/validate-asset.cjs <path>
```

**Tokens:**
```bash
node .gemini/skills/design-system/scripts/generate-tokens.cjs -c tokens.json
node .gemini/skills/design-system/scripts/validate-tokens.cjs -d src/
```
