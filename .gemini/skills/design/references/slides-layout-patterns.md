...
python .gemini/skills/design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python .gemini/skills/design-system/scripts/search-slides.py "traction slide" \
