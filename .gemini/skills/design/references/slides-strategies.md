...
python .gemini/skills/design-system/scripts/search-slides.py "investor pitch" -d strategy

# Get emotion arc
python .gemini/skills/design-system/scripts/search-slides.py "series a funding" -d strategy --json
```
