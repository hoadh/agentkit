...
Task("fullstagk-developer", "Fix Issue A. Claim tasks via TaskUpdate.", "Fix A")
Task("fullstagk-developer", "Fix Issue B. Claim tasks via TaskUpdate.", "Fix B")
```
...
| 2+ independent issues | Task trees per issue + fullstagk-developer agents |
