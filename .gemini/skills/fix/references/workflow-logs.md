...
For fixing issues from application logs. Uses native Gemini Tasks for phase tracking.
...
Use `gk-scout` agent or parallel `Explore` subagents to find issue locations.
