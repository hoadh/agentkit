...
python3 .gemini/skills/ui-ux-pro-max/scripts/search.py "<mood>" --domain typography
python3 .gemini/skills/ui-ux-pro-max/scripts/search.py "<industry>" --domain color
```
...
### 3. Generate Assets
Use `gk-ai-multimodal` skill:
- Generate required visuals
- Verify quality quickly
- Use `gk-media-processing` for adjustments
