...
## Prerequisites
- Activate `gk-ui-ux-pro-max` skill first for design intelligence
- Have `gk-ai-multimodal` skill ready for visual analysis

## Workflow Steps

### 1. Analyze Screenshot Details
Use `gk-ai-multimodal` skill to extract:
...
- Remove backgrounds if needed with `gk-media-processing`
