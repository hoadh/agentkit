...
- Otherwise use `gk-repomix` to generate fresh codebase summary
- Use `skill:scout` or `skill:scout ext` to find relevant files
- Use `gk-docs-seeker` skill for package/plugin documentation
