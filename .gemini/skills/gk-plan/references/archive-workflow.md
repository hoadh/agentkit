...
### Step 2: Summarize the plans and document them with `skill:journal` skill invocation
...
- Stage and commit the changes (Use `skill:git` for commit flow)
- Commit and push the changes (Use `skill:git` for push flow)
