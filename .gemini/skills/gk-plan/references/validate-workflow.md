...
3. If no plan found → Ask user to specify path or run `skill:plan --hard` first
...
> Then run:
> ```
> skill:cook --auto {ABSOLUTE_PATH_TO_PLAN_DIR}/plan.md
> ```
...
> Fresh context helps Gemini focus solely on implementation without planning context pollution.
