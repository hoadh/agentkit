...
```
skill:predict "Add WebSocket support for real-time notifications"
skill:predict "Migrate authentication from JWT to session cookies"
skill:predict "Add multi-tenancy to the database layer"
skill:predict "Replace REST API with GraphQL" --files src/api/**/*.ts
```
