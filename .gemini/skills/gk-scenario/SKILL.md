...
```
skill:scenario src/api/payment.ts
skill:scenario "User registration with OAuth providers"
skill:scenario src/middleware/auth.ts
skill:scenario "Add multi-tenancy to the database layer"
```
