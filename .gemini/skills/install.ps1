...
function Setup-PythonEnv {
    ...
    if (Test-Path $scriptsReqPath) {
        ...
        Write-Info "Installing .gemini/scripts dependencies..."
...
function Get-RemediationCommands {
    ...
    if ($hasPythonFailed) {
        ...
        Write-Host ".\.gemini\skills\.venv\Scripts\Activate.ps1"
...
function Write-ErrorSummary {
    ...
    $summary = @{
        ...
        remediation = @{
            ...
            pip_retry = ".\.gemini\skills\.venv\Scripts\Activate.ps1; pip install <package>"
        }
    }
...
function Show-Usage {
    ...
    Write-Host "  .gemini\skills\INSTALLATION.md"
    Write-Host ""
}

# Show help
function Show-Help {
    Write-Host "Gemini CLI Skills Installation Script for Windows"
    Write-Host ""
    Write-Host "Usage:"
...
function Main {
    ...
    Write-Header "Gemini CLI Skills Installation (Windows)"
