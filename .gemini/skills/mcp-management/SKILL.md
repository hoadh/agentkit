...
- Structured JSON responses (parseable by Gemini)
...
- Config loading from `.gemini/.mcp.json`
...
**Method 2: Scripts**
```bash
cd .gemini/skills/mcp-management/scripts && npm install
