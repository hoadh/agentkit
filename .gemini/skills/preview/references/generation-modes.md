...
When generating mermaid code blocks, use `skill:mermaidjs-v11` skill for v11 syntax rules.
...
For `--slides`: recommend invoking `skill:ui-ux-pro-max` for richer style selection.
Must use `skill:mermaidjs-v11` for any Mermaid diagrams.
