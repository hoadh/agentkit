...
```html
<pre class="code-block code-blogk--scroll"><code>// Your code here
function example() {
  return true;
}</code></pre>
```
...
For AI-generated illustrations embedded as base64 data URIs. Use `skill:ai-multimodal` skill for image generation if available.
