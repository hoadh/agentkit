...
**IMPORTANT:** Run server as Gemini CLI background task using `run_in_background: true` with the Bash tool.

The skill is located at `.gemini/skills/markdown-novel-viewer/`.
