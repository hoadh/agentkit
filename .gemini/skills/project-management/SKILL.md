---
name: gk-project-management
description: "Track progress, update plan statuses, manage Gemini Tasks, generate reports, coordinate docs updates. Use for project oversight, status checks, plan completion, task hydration, cross-session continuity."
...
Project oversight and coordination using Gemini native Tasks with persistent plan files.
...
- Hydrating/syncing Gemini Tasks with plan files
...
- `gk-plan` — Creates implementation plans (planning phase)
- `gk-cook` — Implements plans (execution phase, invokes project-manager at finalize)
