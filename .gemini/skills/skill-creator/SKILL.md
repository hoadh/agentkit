...
Create effective, eval-driven Gemini skills using progressive disclosure and human-in-the-loop iteration.

## Core Principles

- Skills are **practical instructions**, not documentation
- Each skill teaches Gemini *how* to perform tasks, not *what* tools are
...
New skills **MUST** be created in CWD: `./.gemini/skills/` (**NOT** `~/.gemini/skills/` unless requested)
...
2. **Research** — Activate `skill:docs-seeker`, `skill:research` for best practices
...
- [Agent Skills Docs](https://docs.gemini.com/en/docs/gemini-code/skills.md)
- [Best Practices](https://docs.gemini.com/en/docs/agents-and-tools/agent-skills/best-practices.md)
