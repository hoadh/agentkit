...
- **Workflow steps** — Numbered, deterministic sequences Gemini follows
- **Error handling** — Cover edge cases so Gemini doesn't skip concepts
...
- Skill MUST teach Gemini to refuse out-of-scope requests explicitly
...
- **No scope boundaries** — Gemini attempts off-topic requests → low refusal
