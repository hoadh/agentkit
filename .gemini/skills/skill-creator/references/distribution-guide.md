...
2. Zip the folder
3. Upload to Gemini.ai: Settings > Capabilities > Skills
4. Or place in Gemini CLI skills directory: `.gemini/skills/`
...
- Version control through Gemini Console
- Works with Gemini Agent SDK for custom agents

| Use Case | Best Surface |
|---|---|
| End users interacting directly | Gemini.ai / Gemini CLI |
| Manual testing during development | Gemini.ai / Gemini CLI |
...
2. Install: Gemini.ai > Settings > Skills > Upload skill (zipped)
3. Enable: Toggle on the skill, ensure MCP server connected
4. Test: Ask Gemini "[trigger phrase from description]"
```
...
> "Our MCP server gives Gemini access to your Linear projects. Our skills teach Gemini your sprint planning workflow. Together: AI-powered project management."
