...
Plugin marketplace = catalog distributing Gemini CLI extensions across teams/communities.
Provides centralized discovery, version tracking, automatic updates, multiple source types.

## Creation & Distribution Flow

1. **Create plugins** — commands, agents, hooks, MCP servers, LSP servers (see [Plugins docs](https://code.gemini.com/docs/en/plugins.md))
2. **Create marketplace file** — `.gemini-plugin/marketplace.json` listing plugins + sources
...
```bash
# 1. Create structure
mkdir -p my-marketplace/.gemini-plugin
mkdir -p my-marketplace/plugins/review-plugin/.gemini-plugin
...
| `gemini plugin validate .` | CLI validation |

## Validation & Testing

```bash
# Validate marketplace JSON
gemini plugin validate .
# or within Gemini CLI:
/plugin validate .
...
- [Plugin Marketplaces](https://code.gemini.com/docs/en/plugin-marketplaces.md)
- [Discover Plugins](https://code.gemini.com/docs/en/discover-plugins.md)
- [Create Plugins](https://code.gemini.com/docs/en/plugins.md)
- [Plugins Reference](https://code.gemini.com/docs/en/plugins-reference.md)
- [Plugin Settings](https://code.gemini.com/docs/en/settings.md#plugin-settings)
