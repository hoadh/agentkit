...
Full JSON schema for `.gemini-plugin/marketplace.json`.
...
`gemini-code-marketplace`, `gemini-code-plugins`, `gemini-plugins-official`, `google-marketplace`, `google-plugins`, `agent-skills`, `life-sciences`. Names impersonating official marketplaces also blocked.
