...
2. `$HOME/.gemini/skills/<skill-name>/.env` (skill-specific)
3. `$HOME/.gemini/skills/.env` (shared skills)
4. `$HOME/.gemini/.env` (global)
5. `./.gemini/skills/${SKILL}/.env` (cwd)
6. `./.gemini/skills/.env` (cwd)
7. `./.gemini/.env` (cwd)
...
load_dotenv('$HOME/.gemini/.env')
load_dotenv('$HOME/.gemini/skills/.env')
load_dotenv('$HOME/.gemini/skills/my-skill/.env')
load_dotenv('./.gemini/skills/my-skill/.env')
load_dotenv('./.gemini/skills/.env')
