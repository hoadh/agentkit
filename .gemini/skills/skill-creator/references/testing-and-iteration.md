...
- **Manual testing** — Run queries in Gemini.ai, observe behavior. Fast iteration.
- **Scripted testing** — Automate test cases in Gemini CLI for repeatable validation.
- **Programmatic testing** — Build eval suites via skills API for systematic testing.

**Pro tip:** Iterate on a single challenging task until Gemini succeeds, then extract the winning approach into the skill. Expand to multiple test cases after.
...
**Debug:** Ask Gemini: "When would you use the [skill-name] skill?" — it quotes the description back.
...
|---|---|---|
| Messages needed | 15 bagk-and-forth | 2 clarifying questions |
...
### Qualitative
- Users don't need to prompt Gemini about next steps
