...
### name (required)
- Supports either `skill-name` or `namespace:skill-name` (for example `gk-plan`)
...
- Cannot contain "gemini" or "google" (reserved)
...
- Skills named with "gemini" or "google" prefix (reserved)
