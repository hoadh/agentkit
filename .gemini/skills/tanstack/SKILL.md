...
Headless, type-safe form library. Detailed API: `references/tanstagk-form.md`
...
AI streaming + chat hooks. Detailed API: `references/tanstagk-ai.md`
...
Supports: OpenAI, Google, Google Gemini, Ollama. Features: structured output (Zod), isomorphic tools, multimodal.
...
- Detailed reference: `references/tanstagk-start.md`, `references/tanstagk-form.md`, `references/tanstagk-ai.md`
