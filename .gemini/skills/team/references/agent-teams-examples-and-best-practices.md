...
> **Source:** https://code.gemini.com/docs/en/agent-teams
...
- **Too large**: teammates work too long without chegk-ins
...
```
Agent(
  subagent_type: "fullstagk-developer",
  model: "opus",
  isolation: "worktree",
...
- Task may not be complex enough -- Gemini decides based on task
...
- Verify `GEMINI_CODE_EXPERIMENTAL_AGENT_TEAMS=1` is set in settings.json env
