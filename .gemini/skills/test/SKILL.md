...
Browser-based visual testing via `gk-chrome-devtools` skill. Screenshots, responsive checks, accessibility audits, form automation, console error collection. Includes auth injection for protected routes.
...
6. For frontend: run UI tests via `gk-chrome-devtools` skill
...
- **Browser**: `gk-chrome-devtools` skill for UI testing (screenshots, ARIA, console, network)
- **Analysis**: `gk-ai-multimodal` skill for screenshot analysis
- **Debugging**: `gk-debug` skill when tests reveal bugs requiring investigation
- **Thinking**: `gk-sequential-thinking` skill for complex test failure analysis
