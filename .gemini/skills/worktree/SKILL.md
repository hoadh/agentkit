...
```bash
node .gemini/skills/worktree/scripts/worktree.cjs info --json
```
...
**Monorepo:**
```bash
node .gemini/skills/worktree/scripts/worktree.cjs create "<PROJECT>" "<SLUG>" --prefix <TYPE>
```

**Standalone:**
```bash
node .gemini/skills/worktree/scripts/worktree.cjs create "<SLUG>" --prefix <TYPE>
```
