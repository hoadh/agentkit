...
- Primary workflow: `~/.gemini/rules/primary-workflow.md`
- Development rules: `~/.gemini/rules/development-rules.md`
- Orchestration protocols: `~/.gemini/rules/orchestration-protocol.md`
- Documentation management: `~/.gemini/rules/documentation-management.md`
- And other workflows: `~/.gemini/rules/*` (and in current project `./.gemini/rules/*`)

**IMPORTANT:** Analyze the skills catalog and activate the skills that are needed for the task during the process.
**IMPORTANT:** You must follow strictly the development rules in `~/.gemini/rules/development-rules.md` file.
...
* **Windows:** `.gemini\skills\.venv\Scripts\python.exe scripts\xxx.py`
